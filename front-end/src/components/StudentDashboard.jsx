...
const StudentDashboard = () => {
  ...
  return (
    <main className="w-screen font-system-ui min-h-screen bg-[#003d39]">
      ...
      <section className="w-screen text-white py-5 flex gap-5">
        <section
          className={`w-[20%] rounded-3xl lg:translate-x-0 ${sidebarOpen ? "translate-x-0" : "-translate-x-[140%]"
        ...
        >
          ...
          <button
            ...
            className="w-25 my-7 h-10 cursor-pointer bg-[#003d39] text-white text-lg font-bold rounded-2xl hover:bg-[#74EE66] hover:text-black transition duration-200 ease-in"
          >
            Logout
          </button>
        </section>
        ...
        <section className="w-[90%] h-[100%]">
          <section className="w-[95%] rounded-3xl h-170 bg-[#055e58] shadow-lg mx-6">
            {renderSectionData()}
          </section>
        </section>
      </section>
